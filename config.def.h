...
static const char col_cyan[]        = "#fffb77";
...
static const char *prevtrack[] = { "/usr/bin/playerctl", "previous", NULL };
...
static const Key keys[] = {
	...
	{ 0,				 XK_Print, spawn, 	   SHCMD("scrot ~/Pictures/screenshots/%Y-%m-%d-%H%M%S.png") }, 
	{ ShiftMask,			 XK_Print, spawn, 	   SHCMD("scrot -s ~/Pictures/screenshots/%Y-%m-%d-%H%M%S.png") },
